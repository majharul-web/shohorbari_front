...
const AdminDashboards = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: data.ads_last_7_days,
      icon: BarChart,
      color: "text-purple-600",
    },
    {
      label: "Ads This Month",
      value: data.ads_current_month,
      icon: BarChart,
      color: "text-indigo-600",
    },
    {
      label: "Ads Last Month",
      value: data.ads_last_month,
      icon: BarChart,
      color: "text-pink-600",
    },
  ];
    ...
    <div className='p-6'>
      <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3'>
        {stats.map((stat) => {
          ...
          return (
            <Card key={stat.label} className='shadow-md hover:shadow-lg transition'>
