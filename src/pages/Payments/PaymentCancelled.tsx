...
const PaymentCancelled = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-[calc(100vh-10rem)] px-4'>
      ...
      >
        <Card className='border-2 border-dashed border-warning/40 shadow-lg rounded-2xl bg-white/80 backdrop-blur-sm'>
          <CardContent className='flex flex-col items-center justify-center text-center py-12 px-6'>
            ...
            >
              <XCircle className='w-14 h-14 text-warning mb-4' />
            </motion.div>
            ...
            >
              Your payment was cancelled. You can retry the payment or go back to your orders.
            </motion.p>
